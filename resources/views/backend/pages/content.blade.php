              ...
              <ul class="chat-list">
                  <li class="list active">
                      <div class="profile"><img
                              src="{{ asset('backend/vendors/feather/feather.css') }}images/faces/face1.jpg"
                  ...
                  <li class="list">
                      <div class="profile"><img
                              src="{{ asset('backend/vendors/feather/feather.css') }}images/faces/face2.jpg"
                  ...
                  <li class="list">
                      <div class="profile"><img
                              src="{{ asset('backend/vendors/feather/feather.css') }}images/faces/face3.jpg"
                              alt="image"><span class="online"></span></div>
                      <div class="info">
                          <p>Daniel Russell</p>
                          <p>Available</p>
                  ...
                  <li class="list">
                      <div class="profile"><img
                              src="{{ asset('backend/vendors/feather/feather.css') }}images/faces/face4.jpg"
                              alt="image"><span class="offline"></span></div>
                      <div class="info">
                  ...
                  <li class="list">
                      <div class="profile"><img
                              src="{{ asset('backend/vendors/feather/feather.css') }}images/faces/face5.jpg"
                              alt="image"><span class="online"></span></div>
                      <div class="info">
                  ...
                  <li class="list">
                      <div class="profile"><img
                              src="{{ asset('backend/vendors/feather/feather.css') }}images/faces/face6.jpg"
                              alt="image"><span class="online"></span></div>
                      <div class="info">
                          <p>Sarah Graves</p>
                          <p>Available</p>
