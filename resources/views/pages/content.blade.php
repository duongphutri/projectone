...
<div class="main_slider" style="background-image:url{{ asset('assets/images/slider_1.jpg') }}">
    <img src="{{ asset('assets/images/slider_1.jpg') }}" alt="">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="banner_item align-items-center"
                    style="background-image:url{{ asset('assets/images/banner_1.jpg') }}">
                    <img src="{{ asset('assets/images/banner_1.jpg') }}" alt="">
            ...
            <div class="col-md-4">
                <div class="banner_item align-items-center" style="background-image:url(images/banner_2.jpg)">
                    <img src="{{ asset('assets/images/banner_2.jpg') }}" alt="">
                    <div class="banner_category">
            ...
            <div class="col-md-4">
                <div class="banner_item align-items-center" style="background-image:url(images/banner_3.jpg)">
                    <img src="{{ asset('assets/images/banner_3.jpg') }}" alt="">
                    <div class="banner_category">
                ...
                <div class="product-grid" data-isotope='{ "itemSelector": ".product-item", "layoutMode": "fitRows" }'>
                    ...
                    <div class="product-item men">
                        <div class="product discount product_filter">
                            <div class="product_image">
                                <img src="{{ asset('assets/images/product_1.png') }}" alt="">
                            </div>
                    ...
                    <div class="product-item women">
                        <div class="product product_filter">
                            <div class="product_image">
                                <img src="{{ asset('assets/images/product_2.png') }}" alt="">
                            </div>
                    ...
                    <div class="product-item women">
                        <div class="product product_filter">
                            <div class="product_image">
                                <img src="{{ asset('assets/images/product_3.png') }}" alt="">
                            </div>
                            <div class="favorite"></div>
                            <div class="product_info">
                    ...
                    <div class="product-item accessories">
                        <div class="product product_filter">
                            <div class="product_image">
                                <img src="{{ asset('assets/images/product_4.png') }}" alt="">
                            </div>
                            <div
                                class="product_bubble product_bubble_right product_bubble_red d-flex flex-column align-items-center">
                                <span>sale</span>
                    ...
                    <div class="product-item women men">
                        <div class="product product_filter">
                            <div class="product_image">
                                <img src="{{ asset('assets/images/product_5.png') }}" alt="">
                            </div>
                            <div class="favorite"></div>
                            <div class="product_info">
                    ...
                    <div class="product-item accessories">
                        <div class="product discount product_filter">
                            <div class="product_image">
                                <img src="{{ asset('assets/images/product_6.png') }}" alt="">
                            </div>
                            <div class="favorite favorite_left"></div>
                            <div
                                class="product_bubble product_bubble_right product_bubble_red d-flex flex-column align-items-center">
                    ...
                    <div class="product-item women">
                        <div class="product product_filter">
                            <div class="product_image">
                                <img src="{{ asset('assets/images/product_7.png') }}" alt="">
                            </div>
                            <div class="favorite"></div>
                            <div class="product_info">
                                <h6 class="product_name"><a href="single.html">Samsung CF591 Series Curved
                    ...
                    <div class="product-item accessories">
                        <div class="product product_filter">
                            <div class="product_image">
                                <img src="{{ asset('assets/images/product_8.png') }}" alt="">
                            </div>
                            <div class="favorite"></div>
                            <div class="product_info">
                                <h6 class="product_name"><a href="single.html">Blue Yeti USB Microphone
                    ...
                    <div class="product-item men">
                        <div class="product product_filter">
                            <div class="product_image">
                                <img src="{{ asset('assets/images/product_9.png') }}" alt="">
                            </div>
                            <div
                                class="product_bubble product_bubble_right product_bubble_red d-flex flex-column align-items-center">
                                <span>sale</span>
                    ...
                    <div class="product-item men">
                        <div class="product product_filter">
                            <div class="product_image">
                                <img src="{{ asset('assets/images/product_10.png') }}" alt="">
                            </div>
                            <div class="favorite"></div>
                            <div class="product_info">
                                <h6 class="product_name"><a href="single.html">Pryma Headphones, Rose Gold &
